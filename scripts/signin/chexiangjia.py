...
class Chexiangjia(Parser):
    ...
    def get_routine(self):
        ...
        res = yield http_post("https://cxj.activity.chexiang.com/service/dailyfuli/list/0", jdata,
    ...
    def get_dailyredpacket(self, prize_code):
        ...
        yield http_get("https://cxj.activity.chexiang.com/service/dailyfuli/receive?prizeCode={}".format(prize_code),
                       headers=header)
